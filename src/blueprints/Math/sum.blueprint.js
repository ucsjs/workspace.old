...
exports.SumBlueprint = void 0;
var blueprint_1 = require("@ucsjs/blueprint");
var SumBlueprint = /** @class */ (function (_super) {
    __extends(SumBlueprint, _super);
    function SumBlueprint() {
        var _this = _super.call(this) || this;
        //Metadata
        _this.__namespace = "Sum";
        _this.__type = "Math";
        _this.nums = {};
    ...
    SumBlueprint.prototype.parse = function (v, name, scope) {
        scope[name] = v;
...
exports.SumBlueprint = SumBlueprint;

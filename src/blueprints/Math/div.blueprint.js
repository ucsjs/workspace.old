...
exports.DivBlueprint = void 0;
var blueprint_1 = require("@ucsjs/blueprint");
var DivBlueprint = /** @class */ (function (_super) {
    __extends(DivBlueprint, _super);
    function DivBlueprint() {
        var _this = _super.call(this) || this;
        //Metadata
        _this.__namespace = "Div";
        _this.__type = "Math";
        _this.nums = {};
    ...
    DivBlueprint.prototype.parse = function (v, name, scope) {
        scope[name] = v;
...
exports.DivBlueprint = DivBlueprint;

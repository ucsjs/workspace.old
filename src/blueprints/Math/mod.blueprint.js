...
exports.ModBlueprint = void 0;
var blueprint_1 = require("@ucsjs/blueprint");
var ModBlueprint = /** @class */ (function (_super) {
    __extends(ModBlueprint, _super);
    function ModBlueprint() {
        var _this = _super.call(this) || this;
        //Metadata
        _this.__namespace = "Mod";
        _this.__type = "Math";
        _this.nums = {};
    ...
    ModBlueprint.prototype.parse = function (v, name, scope) {
        scope[name] = v;
...
exports.ModBlueprint = ModBlueprint;

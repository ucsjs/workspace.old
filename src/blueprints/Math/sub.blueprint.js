...
exports.SubBlueprint = void 0;
var blueprint_1 = require("@ucsjs/blueprint");
var SubBlueprint = /** @class */ (function (_super) {
    __extends(SubBlueprint, _super);
    function SubBlueprint() {
        var _this = _super.call(this) || this;
        //Metadata
        _this.__namespace = "Sub";
        _this.__type = "Math";
        _this.nums = {};
    ...
    SubBlueprint.prototype.parse = function (v, name, scope) {
        scope[name] = v;
...
exports.SubBlueprint = SubBlueprint;

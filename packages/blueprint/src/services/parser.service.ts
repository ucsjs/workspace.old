...
import { Blueprint, Flow } from "@ucsjs/blueprint";\n`;
                ...
                switch(key){
                    ...
                    case "publicVars":
                        for(let keypublicVar in this._metadata.metadata[key]){
                            ...
                            const type = this._metadata.metadata[key][keypublicVar].type;
                    ...
                    break;
                    case "inputs":
                        inputs = this._metadata.metadata[key];
                    break;
                    case "outputs":
                        outputs = this._metadata.metadata[key];
                    break;
                }
            }
        }
        ...
        //Contructor
        scriptText += `\tconstructor(metadata?: any){
        super();
        this.setup(metadata);\n`;
